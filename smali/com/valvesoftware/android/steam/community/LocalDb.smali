...
.method public declared-synchronized replaceStoredFriendsList(Ljava/util/Collection;Ljava/lang/String;)V
    ...
    :try_start_0
    const-string v3, "INSERT INTO Personas( steamId, personaName, avatarUrl, friendOfSteamId )  VALUES (?,?,?,?);"
    ...
    .line 282
    .local v2, "p":Lcom/valvesoftware/android/steam/community/model/Persona;
    invoke-virtual {v2}, Lcom/valvesoftware/android/steam/community/model/Persona;->isFriend()Z
    ...
    iget-object v6, v2, Lcom/valvesoftware/android/steam/community/model/Persona;->steamId:Ljava/lang/String;
    ...
    iget-object v6, v2, Lcom/valvesoftware/android/steam/community/model/Persona;->personaName:Ljava/lang/String;
    ...
    iget-object v6, v2, Lcom/valvesoftware/android/steam/community/model/Persona;->mediumAvatarUrl:Ljava/lang/String;
    ...
    invoke-virtual {v4, v5, p2}, Landroid/database/sqlite/SQLiteStatement;->bindString(ILjava/lang/String;)V
    ...
    .end local v2    # "p":Lcom/valvesoftware/android/steam/community/model/Persona;
    :catchall_0
    move-exception v5

    :try_start_2
    iget-object v6, p0, Lcom/valvesoftware/android/steam/community/LocalDb;->db:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .restart local v4    # "statement":Landroid/database/sqlite/SQLiteStatement;
    :cond_1
    :try_start_4
    iget-object v5, p0, Lcom/valvesoftware/android/steam/community/LocalDb;->db:Landroid/database/sqlite/SQLiteDatabase;
...
.method public declared-synchronized saveMessages(Ljava/util/List;Ljava/lang/String;Z)I
    ...
    .end local v16    # "rowsInserted":I
    .restart local v17    # "rowsInserted":I
    goto :goto_0
    ...
    check-cast v14, Lcom/valvesoftware/android/steam/community/model/UmqMessage;

    .line 158
    .local v14, "message":Lcom/valvesoftware/android/steam/community/model/UmqMessage;
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/valvesoftware/android/steam/community/LocalDb;->db:Landroid/database/sqlite/SQLiteDatabase;

    iget-object v5, v14, Lcom/valvesoftware/android/steam/community/model/UmqMessage;->chatPartnerSteamId:Ljava/lang/String;

    const-wide/16 v6, 0x0

    iget-wide v8, v14, Lcom/valvesoftware/android/steam/community/model/UmqMessage;->utcTimeStamp:J

    iget-object v10, v14, Lcom/valvesoftware/android/steam/community/model/UmqMessage;->text:Ljava/lang/String;

    iget-boolean v11, v14, Lcom/valvesoftware/android/steam/community/model/UmqMessage;->isIncoming:Z
    ...
    invoke-static/range {v18 .. v18}, Lcom/valvesoftware/android/steam/community/LocalDb;->executeInsert(Landroid/database/sqlite/SQLiteStatement;)Z
    ...
    .line 162
    .end local v14    # "message":Lcom/valvesoftware/android/steam/community/model/UmqMessage;
    .end local v15    # "result":Z
    .end local v18    # "statement":Landroid/database/sqlite/SQLiteStatement;
    :cond_3
    move-object/from16 v0, p0
