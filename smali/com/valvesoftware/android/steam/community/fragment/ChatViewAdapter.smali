...
.method private FormatMessageText(Lcom/valvesoftware/android/steam/community/model/UmqMessage;Landroid/widget/TextView;)V
    ...
    .line 238
    .local v12, "sTimestamp":Ljava/lang/String;
    :try_start_0
    move-object/from16 v0, p0

    iget v0, v0, Lcom/valvesoftware/android/steam/community/fragment/ChatViewAdapter;->m_numSecondsTimestamps:I
    ...
    invoke-static/range {v17 .. v17}, Ljava/text/SimpleDateFormat;->getTimeInstance(I)Ljava/text/DateFormat;
    ...
    iget-object v0, v0, Lcom/valvesoftware/android/steam/community/model/UmqMessage;->text:Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v16}, Landroid/text/SpannableString;->valueOf(Ljava/lang/CharSequence;)Landroid/text/SpannableString;

    move-result-object v13

    .line 252
    .local v13, "spannedText":Landroid/text/SpannableString;
    :goto_1
    const/16 v16, 0xf
    ...
    .line 254
    .local v14, "urls":[Ljava/lang/Object;
    if-eqz v14, :cond_7
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/valvesoftware/android/steam/community/SteamCommunityApplication;->GetSettingInfoDB()Lcom/valvesoftware/android/steam/community/SettingInfoDB;

    move-result-object v16

    move-object/from16 v0, v16

    iget-object v0, v0, Lcom/valvesoftware/android/steam/community/SettingInfoDB;->m_settingChatsAlertLinks:Lcom/valvesoftware/android/steam/community/SettingInfo;
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/valvesoftware/android/steam/community/SteamCommunityApplication;->getApplicationContext()Landroid/content/Context;

    move-result-object v17

    invoke-virtual/range {v16 .. v17}, Lcom/valvesoftware/android/steam/community/SettingInfo;->getBooleanValue(Landroid/content/Context;)Z

    move-result v5

    .line 256
    .local v5, "bAlertUnsafeLinks":Z
    move-object v4, v14
    ...
    .line 257
    .local v15, "xUrl":Ljava/lang/Object;
    invoke-virtual {v13, v15}, Landroid/text/SpannableString;->getSpanStart(Ljava/lang/Object;)I

    move-result v11

    .line 258
    .local v11, "nStart":I
    invoke-virtual {v13, v15}, Landroid/text/SpannableString;->getSpanEnd(Ljava/lang/Object;)I

    move-result v10

    .line 259
    .local v10, "nEnd":I
    invoke-virtual {v13, v15}, Landroid/text/SpannableString;->getSpanFlags(Ljava/lang/Object;)I

    move-result v6

    .line 264
    .local v6, "flags":I
    instance-of v0, v15, Landroid/text/style/URLSpan;
    ...
    .line 265
    invoke-virtual {v13, v15}, Landroid/text/SpannableString;->removeSpan(Ljava/lang/Object;)V
    ...
    .line 269
    new-instance v18, Lcom/valvesoftware/android/steam/community/fragment/UnsafeClickableURL;
    ...
    .end local v15    # "xUrl":Ljava/lang/Object;
    invoke-static {v15}, Lcom/valvesoftware/android/steam/community/fragment/UrlChecker;->isUrlUnsafe(Landroid/text/style/URLSpan;)Z
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/valvesoftware/android/steam/community/fragment/UnsafeClickableURL;-><init>(Landroid/text/style/URLSpan;ZLandroid/support/v4/app/FragmentActivity;)V

    move-object/from16 v0, v18

    invoke-virtual {v13, v0, v11, v10, v6}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
    ...
    .end local v5    # "bAlertUnsafeLinks":Z
    .end local v6    # "flags":I
    .end local v7    # "i$":I
    .end local v8    # "len$":I
    .end local v10    # "nEnd":I
    .end local v11    # "nStart":I
    .end local v13    # "spannedText":Landroid/text/SpannableString;
    .end local v14    # "urls":[Ljava/lang/Object;
    :cond_3
    move-object/from16 v0, p1
    ...
    .restart local v13    # "spannedText":Landroid/text/SpannableString;
    goto/16 :goto_1

    .line 269
    .restart local v4    # "arr$":[Ljava/lang/Object;
    .restart local v5    # "bAlertUnsafeLinks":Z
    .restart local v6    # "flags":I
    .restart local v7    # "i$":I
    .restart local v8    # "len$":I
    .restart local v10    # "nEnd":I
    .restart local v11    # "nStart":I
    .restart local v14    # "urls":[Ljava/lang/Object;
    :cond_4
    const/16 v17, 0x0
    ...
    .line 275
    .restart local v15    # "xUrl":Ljava/lang/Object;
    :cond_5
    if-eqz v12, :cond_2
    ...
    .line 279
    invoke-virtual {v13, v15, v11, v10, v6}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
    :try_end_1
    ...
    .line 289
    .local v9, "mm":Landroid/text/method/MovementMethod;
    if-eqz v9, :cond_8

    instance-of v0, v9, Landroid/text/method/LinkMovementMethod;
    ...
    .line 292
    .end local v9    # "mm":Landroid/text/method/MovementMethod;
    :catch_1
    move-exception v16
