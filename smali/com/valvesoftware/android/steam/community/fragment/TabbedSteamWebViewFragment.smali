...
.method private UpdateToggleButtonStyles()V
    ...
    .prologue
    .line 114
    sget-object v0, Lcom/valvesoftware/android/steam/community/fragment/TabbedSteamWebViewFragment;->m_categoryButtons:[I
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/app/FragmentActivity;->findViewById(I)Landroid/view/View;
    ...
    .line 116
    .local v1, "catButton":Landroid/widget/ToggleButton;
    if-nez v1, :cond_0
    ...
    .line 118
    :cond_0
    invoke-static {v1}, Lcom/valvesoftware/android/steam/community/activity/ActivityHelper;->UpdateToggleButtonStyles(Landroid/widget/ToggleButton;)V

    goto :goto_1

    .line 120
    .end local v1    # "catButton":Landroid/widget/ToggleButton;
    .end local v4    # "m_categoryButton":I
    :cond_1
    return-void
.end method
